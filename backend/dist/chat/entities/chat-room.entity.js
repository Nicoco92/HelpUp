...
], ChatRoom.prototype, "mission", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => chat_participant_entity_1.ChatParticipant, (cp) => cp.chatRoom, { cascade: true, eager: true }),
    __metadata("design:type", Array)
], ChatRoom.prototype, "participants", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => message_entity_1.Message, (m) => m.chatRoom),
    __metadata("design:type", Array)
