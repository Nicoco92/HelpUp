...
let ReviewsController = class ReviewsController {
    ...
    async getReviewsForUser(userId, limit, offset) {
        return this.reviewsService.getReviewsForUser(userId, limit ? Number(limit) : 20, offset ? Number(offset) : 0);
    }
    async getReviewsForMission(missionId) {
        return this.reviewsService.getReviewsForMission(missionId);
    }
    async getReviewStatus(missionId) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "getReviewsForMission", null);
__decorate([
    (0, common_1.Get)('mission/:missionId/status'),
    __param(0, (0, common_1.Param)('missionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
